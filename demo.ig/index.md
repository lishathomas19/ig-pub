...
```json
{
  ...
  "id" : "demo.ig",
  "url" : "https://lishathomas19.github.io/ig-pub/demo.ig/ImplementationGuide/demo.ig",
  "version" : "1.0.0",
  ...
  "description" : "Simple demo IG with one Patient profile and example.",
  "packageId" : "demo.ig",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "https://lishathomas19.github.io/ig-pub/demo.ig/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      {
        ...
        "reference" : {
          "reference" : "Patient/DemoPatientExample"
        },
        "name" : "Demo Patient Example",
        "description" : "Example Patient that conforms to DemoPatient.",
        "exampleCanonical" : "https://lishathomas19.github.io/ig-pub/demo.ig/StructureDefinition/demo-patient"
      },
      {
        "extension" : [
          {
        ...
        "reference" : {
          "reference" : "StructureDefinition/demo-patient"
        },
        "name" : "Demo Patient Profile",
